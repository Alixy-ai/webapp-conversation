...
const Button: FC<IButtonProps> = ({
  ...
  switch (type) {
    case 'link':
      style = disabled ? 'border-solid border border-gray-200 bg-gray-200 cursor-not-allowed text-gray-800' : 'border-solid border border-gray-200 cursor-pointer text-primary-700 bg-white hover:shadow-sm hover:border-gray-300'
      break
    case 'primary':
